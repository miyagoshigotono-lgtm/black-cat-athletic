...
export const playCameraParams = {
  ...
  distance: 1.8,
  /**
   * 注視点の高さ（猫の当たり判定の中心からの上乗せ）[m]。
   * 地面から 0.14 + 0.08 = 0.22。高さ 0.35 のトンネル内でも判定球（0.16〜0.28）が天井に触れない値。
   */
  targetHeight: 0.08,
  ...
  maxPitch: 1.3,
  /**
   * めり込み判定に飛ばす球の半径 [m]。ニアクリップ面（0.03m・画角60°・横長比 2.2 まで）の
   * 四隅までの距離 約 0.051 を覆う大きさ。
   */
  probeRadius: 0.06,
